...
const STEPS = [
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img">
...
export default function AppleVisionSection() {
    ...
    STEPS.map((step, i) => (
      ...
      >
        <div className="relative flex items-center space-x-6">
          <div 
            className="w-14 h-14 bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-lg flex items-center justify-center backdrop-blur-sm border border-white/10 group-hover:border-white/20 transition-all duration-300"
            aria-hidden="true"
          >
  ...
  return (
    <section 
      className="relative py-32 lg:py-40 xl:py-48 px-4 sm:px-6 lg:px-8 xl:px-12 bg-[#111111] m-2 rounded-lg overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <span 
            className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-purple-400/80 via-blue-400/80 to-purple-400/80 text-sm uppercase tracking-[0.2em] mb-4 font-light"
            aria-hidden="true"
          >
            Vision & Innovation
          </span>
        ...
        >
          ...
          >
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-zinc-900 to-black border border-white/10">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {/* Background Grid */}
                <div 
                  className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:24px_24px] transform -skew-y-12"
                  aria-hidden="true"
                />
              ...
              <div 
                className="absolute -top-1/2 -left-1/2 w-full h-full bg-purple-500/5 rounded-full blur-[100px] animate-pulse transform -skew-y-12"
                aria-hidden="true"
              />
              <div 
                className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-blue-500/5 rounded-full blur-[100px] animate-pulse transform -skew-y-12"
                aria-hidden="true"
              />
            </div>
          </div>
          ...
          <div 
            ...
            role="complementary"
            aria-label="Détails de notre vision"
          >
            {/* Vision statement */}
