...
const ControlButton = memo(({ 
  ...
  >
    <div 
      className={`absolute inset-0 bg-gradient-to-r ${gradientColors} rounded-full md:rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
      aria-hidden="true"
    ></div>
    ...
    >
      <div className="max-w-6xl xl:max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          role="region"
          aria-label="Lecteur vidéo de démonstration"
        >
          <div className="relative" ref={containerRef}>
            <div 
              className="absolute -inset-0.5 bg-gradient-to-r from-purple-500/30 via-blue-500/30 to-emerald-500/30 rounded-2xl lg:rounded-3xl blur-2xl opacity-75"
              aria-hidden="true"
            ></div>
            ...
            <div className="relative bg-gradient-to-br from-zinc-900 via-black to-zinc-900 rounded-2xl lg:rounded-3xl overflow-hidden border border-white/20 backdrop-blur-xl shadow-2xl">
              ...
              <div 
                className="h-8 bg-gradient-to-r from-zinc-800 via-zinc-900 to-zinc-800 border-b border-white/10 flex items-center px-4"
                role="toolbar"
              ...
              <div 
                ...
                role="region"
                aria-label="Zone de lecture vidéo"
              >
                <video
                  ref={videoRef}
                  ...
                  aria-label="Démonstration HEXPOZ"
                />
          ...
          <div 
            className="absolute -top-8 -right-8 w-32 h-32 bg-blue-500/20 rounded-full blur-[32px] animate-pulse"
            aria-hidden="true"
          ></div>
          <div 
            className="absolute -bottom-8 -left-8 w-32 h-32 bg-purple-500/20 rounded-full blur-[32px] animate-pulse"
            aria-hidden="true"
          ></div>
          <div 
            className="absolute top-1/2 -translate-y-1/2 -right-4 w-24 h-24 bg-emerald-500/20 rounded-full blur-[24px] animate-pulse"
            aria-hidden="true"
          ></div>
          <div 
            className="absolute top-1/2 -translate-y-1/2 -left-4 w-24 h-24 bg-pink-500/20 rounded-full blur-[24px] animate-pulse"
            aria-hidden="true"
          ></div>
        </motion.div>
      </div>
